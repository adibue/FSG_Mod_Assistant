...
const serveIPC = {
	 ...
	 * @property {number} gameVersion Detected preferred game version
	 * @property {Object.<number, string>} games Detected game executable paths by version
	 ...
	 * @property {Object.<number, string>} settings Detected game settings paths by version
	 */
	path : {
		game        : '',
		games       : {},
