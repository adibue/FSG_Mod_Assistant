...
module.exports.defaultSettings = class {
	...
	get defaults () {
		const detectedVersion = serveIPC.path.gameVersion || 22
		const gamePath        = (version) => serveIPC.path.games?.[version] || ''
		const settingsPath    = (version) => serveIPC.path.settings?.[version] || ''
		const gameEnabled     = (version) => gamePath(version) !== '' || settingsPath(version) !== ''
		...
		return {
			...
			game_version      : { type : 'number',  default : detectedVersion, enum : [25, 22, 19, 17, 15, 13]},
			...
			game_enabled_25   : { type : 'boolean', default : gameEnabled(25)},
			game_path_25      : { type : 'string',  default : gamePath(25) },
			game_settings_25  : { type : 'string',  default : settingsPath(25) },

			game_args_22      : { type : 'string',  default : '' },
			game_enabled_22   : { type : 'boolean', default : gameEnabled(22)},
			game_path_22      : { type : 'string',  default : gamePath(22) },
			game_settings_22  : { type : 'string',  default : settingsPath(22) },

			game_args_19      : { type : 'string',  default : '' },
			game_enabled_19   : { type : 'boolean', default : gameEnabled(19)},
			game_path_19      : { type : 'string',  default : gamePath(19) },
			game_settings_19  : { type : 'string',  default : settingsPath(19) },

			game_args_17      : { type : 'string',  default : '' },
			game_enabled_17   : { type : 'boolean', default : gameEnabled(17)},
			game_path_17      : { type : 'string',  default : gamePath(17) },
			game_settings_17  : { type : 'string',  default : settingsPath(17) },

			game_args_15      : { type : 'string',  default : '' },
			game_enabled_15   : { type : 'boolean', default : gameEnabled(15)},
			game_path_15      : { type : 'string',  default : gamePath(15) },
			game_settings_15  : { type : 'string',  default : settingsPath(15) },

			game_args_13      : { type : 'string',  default : '' },
			game_enabled_13   : { type : 'boolean', default : gameEnabled(13)},
			game_path_13      : { type : 'string',  default : gamePath(13) },
			game_settings_13  : { type : 'string',  default : settingsPath(13) },
